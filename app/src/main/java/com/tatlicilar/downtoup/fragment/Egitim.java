...
//                        getActivity().startActivity(myIntent2);
    ...
    private void egitimkategorileri() {
        ...
        egitimList.add(new EgitimKategori("Alışveriş Adımları", "Neval Göksel","\tMeleklerin bilinçli alışveriş yapabilmesi amaçlanmaktadır.",R.drawable.shop,"http://www.letstry-ict.eu/advisor/frontend/index.php?showDetail=1&detail_id=23&search_term=&filter_7_5=1"));
